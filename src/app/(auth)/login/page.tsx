  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-blue-400/20 rounded-full blur-2xl"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          ...
          <h1 className="text-5xl font-bold mb-4 tracking-tight">Scrumbies</h1>
          <p className="text-xl text-white/80 text-center max-w-md leading-relaxed">
            Streamline your sprints, collaborate seamlessly, and ship faster.
          </p>
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="flex items-center gap-3 text-white/90">
              ...
              <span>Documentation Spaces</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
